...
return [
    ...
    'exempt-environments' => [''],
    /**
     * An array of routes that will never show the maintenance page
     *
     * To be used in conjunction with the RoutesWhitelist exemption class
     *
     * @var array
     */
    'exempt-routes'       => [''],
    ...
    'exemptions'          => [
         ...
         * EnvironmentWhitelist exempts installations with environments matched in the "exempt-environments" config
         */
        App\Exemptions\RouteWhitelist::class,
    ],
];
