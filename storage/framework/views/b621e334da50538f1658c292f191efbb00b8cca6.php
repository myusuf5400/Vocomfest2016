		...
		<div class="row">
			<div class="col-md-12">
				<aside class="col-md-4 upload pd-bt-40">
					...
					<p class="text-center"><a href="<?php echo e(url('petunjuk/ketentuan MADC.pdf')); ?>" class="btn btn-learn"><i class="icon-download"></i>&nbsp;<strong>DOWNLOAD</strong></a></p>
				</aside>
				<div class="col-md-8">
					...
					<p>Dan jangan lupa upload proposal kamu <a href="<?php echo e(url('/user/upload')); ?>">disini</a></p>
				</div>
			</div>
		</div>
	</div>
