<?php $__env->startSection('title', 'Web Design Competition'); ?>
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane" id="term">
                        ...
                        <ol>
                            ...
                            <li>
                                Tim mendaftar secara online di website <a href="<?php echo e(url('/register')); ?>">www.vocomfest.com/register</a> atau mendaftar pada stand di lobby KPTU Sekolah Vokasi Universitas Gadjah Mada Sekip Unit I Yogyakarta.
                            </li>
                            <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="time">
                                        ...
                                        <ol>
                                            <li>
                                                Peserta mengisi formulir pendaftaran yang ada di web <a href="<?php echo e(url('/register')); ?>">www.vocomfest.com/register</a> atau mendaftar pada stan di KPTU Sekolah Vokasi Universitas Gadjah Mada Sekip Unit I Yogyakarta.
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                Sebelum mengirimkan bukti pembayaran, akun peserta tidak dapat login ke website www.vocomfest.com, pembayaran akan diverifikasi terlebih dahulu lalu peserta dapat login di website <a href="<?php echo e(url('/login')); ?>">www.vocomfest.com/login</a> dengan email ketua dan password saat registrasi.
                                            </li>
                                            <li>
                                                Hasil karya dikirimkan melalui website <a href="<?php echo e(url('/user/upload')); ?>">www.vocomfest.com</a> dengan nama folder: WDC_nama tim_nama website kedinasan yang digunakan, contoh : WDC_Doa Anak_Pariwisata Bali.
                                            </li>
                                            <li>
