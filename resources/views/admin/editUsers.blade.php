                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                @foreach($data as $apa)
                                    <form role="form" method="post" action="{{ url('/admin/table/users/update/') }}/{{ $apa->id }}">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="level" name="level" value="{{ $apa->level }}" placeholder="Level">
                                      </div>
